...
**HC status:** needed
**Missing anchor sections:** historical_context, essential_params, patches

**Tier 3 signals:**
- 3 anchor sections missing: historical_context, essential_params, patches
...
**Tier 3 signals:**
- Old-gen table column headers present: | Advanced Concept |
...
**Tier 3 signals:**
- Duplicate patch numbers detected: [0, 3, 4]
...
*For the full standards audit, run `python3 tooling/audit_guides.py`.*
*This triage report focuses on generational rebuild prioritization only.*