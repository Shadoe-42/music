...
Ikutaro Kakehashi founded Roland Corporation in Osaka in April 1972 with a specific commercial strategy that set it apart from the American synthesizer industry. Moog and ARP had built instruments for professional studios and universities, where price was secondary to capability. Kakehashi targeted a different customer: the working musician and the amateur, people who needed reliable instruments at prices they could actually afford. That philosophy shaped every Roland product that followed, including the two synthesizer systems that eventually produced the dual envelope architecture this module inherits.

Roland's System 100 arrived in 1975 as a semi-modular instrument, a set of interconnected components that could be purchased and expanded incrementally rather than as a single expensive unit. The 101 keyboard synthesizer, 102 expander, 103 mixer, and 104 sequencer could be combined in stages, which made the system financially accessible in a way that Moog's modular systems were not. British post-punk and synthpop musicians in particular found the System 100 useful: Daniel Miller of The Normal used it on the recordings that would eventually anchor the early Depeche Mode sessions, and The Human League built core sequences on it for their first two albums. What these users shared was a preference for a system that could be assembled piece by piece and operated without extensive technical background.

By late 1978, Roland had launched the System 100M, the fully modular successor to the semi-modular 100. The 100M introduced a rack-format architecture with more than twenty dedicated modules, each handling a specific synthesis function. The dual ADSR envelope module in that system reflected a design principle Kakehashi's team had developed across years of instrument building: that the envelope generator was not an accessory to voice design but its timing backbone. A complete synthesizer voice required at least two coordinated envelopes, one for amplitude and one for filter, and those envelopes needed to start from the same gate signal while remaining independently adjustable. Packaging two synchronized envelopes in a single module was a direct expression of how Roland understood voice architecture: as a coordinated system rather than a collection of independent components.

Behringer announced their System 100 Eurorack clone series at NAMM in January 2020, pricing modules between fifty and ninety-nine dollars. The strategy extended Kakehashi's original affordability logic into the modular format: circuits that had previously required purchasing vintage Roland hardware at collector prices were now available as new production units. The 1003 dual envelope generator carried the coordinated synchronization architecture of the System 100M design into that accessible price range. The shared gate input triggering both envelopes, the independent timing controls, and the bipolar outputs were not simplifications; they were the Roland design, reproduced at a price point consistent with how Kakehashi had positioned his instruments from the beginning. The question the 1003 poses is the same one the System 100M posed in 1978: whether the student has internalized why two synchronized envelopes are more useful than two independent ones.
